...
" Vim syntax file for browsing dumpsys files
...
syn match aplogDelimit 'ACTIVITY MANAGER BROADCAST STATE'
syn match aplogDelimit 'Historical.*'
syn match aplogDataFilename 'ActivityInfo'
syn match aplogDataFilename 'ApplicationInfo'
syn match aplogActivity 'ReceiverList'
syn match aplogActivity 'ResolveInfo'
syn match aplogActivity 'BroadcastRecord'
syn match aplogComment 'BroadcastFilter'
syn match aplogTrace '[\.[:alpha:]]*\.[_A-Z]\+[_A-Z]\+'
